...
#pragma GCC ivdep
		for (integer iii = H_NX * H_NX; iii != H_N3 - H_NX * H_NX; ++iii) {
			slpx[field][iii] = minmod(Vfield[iii + H_DNX] - Vfield[iii], Vfield[iii] - Vfield[iii - H_DNX]);
			slpy[field][iii] = minmod(Vfield[iii + H_DNY] - Vfield[iii], Vfield[iii] - Vfield[iii - H_DNY]);
			slpz[field][iii] = minmod(Vfield[iii + H_DNZ] - Vfield[iii], Vfield[iii] - Vfield[iii - H_DNZ]);
		}
	}
...
//#pragma GCC ivdep
	...
	auto minmod_step = [](real &lhs, real const &r1, real const &r2, real const &r3) {
		lhs = minmod(lhs, minmod_theta(r1 - r2, r2 - r3, 2.0));
	};
