...
void options::show_help() {
    printf( "Command line options for Octo-tiger\n\n"
            ...
            "-Cuda_streams_per_locality=<int>      - Defines how many cuda streams per locality will be used. 0 (default) will turn cuda off!\n"
            "-Cuda_streams_per_gpu=<int>           - Defines how many cuda streams per device will be used. Defaults to Cuda_streams_per_locality to only use one device. If it is less\n"
            "                                        than that, Octotiger tries to use multiple cuda devices!\n"
