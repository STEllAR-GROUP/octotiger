...
HPX_ACTION_USES_HUGE_STACK (node_server::scf_update_action);
HPX_ACTION_USES_HUGE_STACK (node_server::find_omega_part_action);
HPX_ACTION_USES_HUGE_STACK (node_server::set_grid_action);
HPX_ACTION_USES_HUGE_STACK (node_server::force_nodes_to_exist_action);
HPX_ACTION_USES_HUGE_STACK (node_server::check_for_refinement_action);
HPX_ACTION_USES_HUGE_STACK (node_server::set_aunt_action);
HPX_ACTION_USES_HUGE_STACK (node_server::get_nieces_action);
HPX_ACTION_USES_HUGE_STACK (node_server::load_action);
HPX_ACTION_USES_HUGE_STACK (node_server::save_action);
HPX_ACTION_USES_HUGE_STACK (node_server::send_hydro_children_action);
HPX_ACTION_USES_HUGE_STACK (node_server::send_hydro_flux_correct_action);
...
HPX_ACTION_USES_HUGE_STACK (node_server::scf_params_action);
...
HPX_ACTION_USES_HUGE_STACK (node_server::velocity_inc_action);
