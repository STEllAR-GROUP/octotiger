    ...
    namespace multipole_interactions {
        template <typename T>
         inline void compute_kernel_rho(T (&X)[NDIM], T (&Y)[NDIM], T (&m_partner)[20],
            T (&tmpstore)[20], T (&tmp_corrections)[3], T (&m_cell)[20],
            ...
            // tmpstore[13] = tmpstore[13] + D_lower[13];
            // tmpstore[14] = tmpstore[14] + D_lower[14];
            // tmpstore[15] = tmpstore[15] + D_lower[15];
            // tmpstore[16] = tmpstore[16] + D_lower[16];
            // tmpstore[17] = tmpstore[17] + D_lower[17];
            // tmpstore[18] = tmpstore[18] + D_lower[18];
            // tmpstore[19] = tmpstore[19] + D_lower[19];
                ...
                T n0_constant = 0.0;
                if(m_cell[0][0] && m_cell[0][1] && m_cell[0][2] && m_cell[0][3])
        ...
        void m2m_kernel::blocked_interaction_rho(
            ...
            for (size_t inner_stencil_index = 0; inner_stencil_index < STENCIL_BLOCKING &&
                ...
                compute_kernel_rho<m2m_vector>(
                  ...
                  // tmpstore[0] += local_expansions_SoA.value<0>(interaction_partner_flat_index);
                  // tmpstore[1] += local_expansions_SoA.value<1>(interaction_partner_flat_index);
                  // tmpstore[2] += local_expansions_SoA.value<2>(interaction_partner_flat_index);
                  // tmpstore[3] += local_expansions_SoA.value<3>(interaction_partner_flat_index);
                  // tmpstore[4] += local_expansions_SoA.value<4>(interaction_partner_flat_index);
                  // tmpstore[5] += local_expansions_SoA.value<5>(interaction_partner_flat_index);
                  // tmpstore[6] += local_expansions_SoA.value<6>(interaction_partner_flat_index);
                  // tmpstore[7] += local_expansions_SoA.value<7>(interaction_partner_flat_index);
                  // tmpstore[8] += local_expansions_SoA.value<8>(interaction_partner_flat_index);
                  // tmpstore[9] += local_expansions_SoA.value<9>(interaction_partner_flat_index);
                  // tmpstore[10] += local_expansions_SoA.value<10>(interaction_partner_flat_index);
                  // tmpstore[11] += local_expansions_SoA.value<11>(interaction_partner_flat_index);
                  // tmpstore[12] += local_expansions_SoA.value<12>(interaction_partner_flat_index);
                  // tmpstore[13] += local_expansions_SoA.value<13>(interaction_partner_flat_index);
                  // tmpstore[14] += local_expansions_SoA.value<14>(interaction_partner_flat_index);
                  // tmpstore[15] += local_expansions_SoA.value<15>(interaction_partner_flat_index);
                  // tmpstore[16] += local_expansions_SoA.value<16>(interaction_partner_flat_index);
                  // tmpstore[17] += local_expansions_SoA.value<17>(interaction_partner_flat_index);
                  // tmpstore[18] += local_expansions_SoA.value<18>(interaction_partner_flat_index);
                  // tmpstore[19] += local_expansions_SoA.value<19>(interaction_partner_flat_index);
                // for (auto i = 0; i < 20; ++i) {
