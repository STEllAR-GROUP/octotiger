...
constexpr uint64_t INNER_CELLS = detail::p2p_kernel::const_pow(INNER_CELLS_PER_DIRECTION, DIMENSION);
...
constexpr uint64_t EXPANSION_COUNT_PADDED = detail::p2p_kernel::const_pow(PADDED_STRIDE, DIMENSION);
