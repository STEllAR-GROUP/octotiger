...
namespace fmm {
    namespace monopole_interactions {
        ...
        std::pair<oct::vector<multiindex<>>, oct::vector<std::array<real, 4>>> calculate_stencil() {
            ...
            oct::vector<std::array<real, 4>> four_constants;
            ...
            return std::pair<oct::vector<multiindex<>>, oct::vector<std::array<real, 4>>>(
                superimposed_stencil, four_constants);
        }
        std::pair<oct::vector<bool>, oct::vector<std::array<real, 4>>>
        calculate_stencil_masks(oct::vector<multiindex<>> superimposed_stencil) {
            ...
            oct::vector<std::array<real, 4>> four_constants_stencil(FULL_STENCIL_SIZE, four_constants_defaults);
            for (auto stencil_element : superimposed_stencil) {
            ...
            return std::pair<oct::vector<bool>, oct::vector<std::array<real, 4>>>(stencil_masks, four_constants_stencil);
