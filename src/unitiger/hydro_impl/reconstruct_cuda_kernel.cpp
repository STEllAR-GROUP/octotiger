...
__device__ inline void reconstruct_inner_loop_p1(const size_t nf_, const int angmom_index_,
    ...
    const double dx, const double* __restrict__ cdiscs, const int d, const int i, const int q_i,
...
__device__ inline void reconstruct_inner_loop_p2(const safe_real omega, const int angmom_index_,
    double* __restrict__ combined_q, double* __restrict__ combined_x,
    double* __restrict__ combined_u, double* __restrict__ AM, const double dx, const int d,
