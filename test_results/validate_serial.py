...
bodies='\n'.join(method(s) for s in ['void rad_grid::allocate()', 'void rad_grid::set_dx(',
 ...
 'void rad_grid::advance(', 'void rad_grid::sanity_check()', 'void rad_grid::applyRegressionSource(',
...
fixture='#include \"'+str(pathlib.Path(__file__).resolve().parent/'support/plot_output.hpp')+'\"\n'+r'''
