...
namespace fmm {
    namespace monopole_interactions {
        ...
        CUDA_GLOBAL_METHOD inline void compute_interaction_p2m_rho(const T& d2, const T& d3,
            ...
            tmp_corrections[0] -= m_partner[10] * (D_upper[0] * multipole_interactions::factor_sixth[10]);
            tmp_corrections[1] -= m_partner[10] * (D_upper[1] * multipole_interactions::factor_sixth[10]);
            tmp_corrections[2] -= m_partner[10] * (D_upper[2] * multipole_interactions::factor_sixth[10]);
            ...
            tmp_corrections[0] -= m_partner[11] * (D_upper[1] * multipole_interactions::factor_sixth[11]);
            tmp_corrections[1] -= m_partner[11] * (D_upper[3] * multipole_interactions::factor_sixth[11]);
            tmp_corrections[2] -= m_partner[11] * (D_upper[4] * multipole_interactions::factor_sixth[11]);
            ...
            tmp_corrections[0] -= m_partner[12] * (D_upper[2] * multipole_interactions::factor_sixth[12]);
            tmp_corrections[1] -= m_partner[12] * (D_upper[4] * multipole_interactions::factor_sixth[12]);
            tmp_corrections[2] -= m_partner[12] * (D_upper[5] * multipole_interactions::factor_sixth[12]);
            
            D_upper[6] = 3.0 * d3_X01;
            D_upper[7] = d3 * dX[0] * dX[2];

            tmp_corrections[0] -= m_partner[13] * (D_upper[3] * multipole_interactions::factor_sixth[13]);
            tmp_corrections[1] -= m_partner[13] * (D_upper[6] * multipole_interactions::factor_sixth[13]);
            tmp_corrections[2] -= m_partner[13] * (D_upper[7] * multipole_interactions::factor_sixth[13]);

            D_upper[8] = d3 * dX[0] * dX[1];

            tmp_corrections[0] -= m_partner[14] * (D_upper[4] * multipole_interactions::factor_sixth[14]);
            tmp_corrections[1] -= m_partner[14] * (D_upper[7] * multipole_interactions::factor_sixth[14]);
            tmp_corrections[2] -= m_partner[14] * (D_upper[8] * multipole_interactions::factor_sixth[14]);

            D_upper[9] = 3.0 * d3_X02;

            tmp_corrections[0] -= m_partner[15] * (D_upper[5] * multipole_interactions::factor_sixth[15]);
            tmp_corrections[1] -= m_partner[15] * (D_upper[8] * multipole_interactions::factor_sixth[15]);
            tmp_corrections[2] -= m_partner[15] * (D_upper[9] * multipole_interactions::factor_sixth[15]);
            ...
            tmp_corrections[0] -= m_partner[16] * (D_upper[6] * multipole_interactions::factor_sixth[16]);
            tmp_corrections[1] -= m_partner[16] * (D_upper[10] * multipole_interactions::factor_sixth[16]);
            tmp_corrections[2] -= m_partner[16] * (D_upper[11] * multipole_interactions::factor_sixth[16]);

            D_upper[12] = d2;
            D_upper[12] += d3_X22;
            D_upper[12] += d3_X11;

            tmp_corrections[0] -= m_partner[17] * (D_upper[7] * multipole_interactions::factor_sixth[17]);
            tmp_corrections[1] -= m_partner[17] * (D_upper[11] * multipole_interactions::factor_sixth[17]);
            tmp_corrections[2] -= m_partner[17] * (D_upper[12] * multipole_interactions::factor_sixth[17]);

            D_upper[13] = 3.0 * d3_X12;

            tmp_corrections[0] -= m_partner[18] * (D_upper[8] * multipole_interactions::factor_sixth[18]);
            tmp_corrections[1] -= m_partner[18] * (D_upper[12] * multipole_interactions::factor_sixth[18]);
            tmp_corrections[2] -= m_partner[18] * (D_upper[13] * multipole_interactions::factor_sixth[18]);

            D_upper[14] = dX[2] * dX[2] * d3 + 2.0 * d2;
            D_upper[14] += d2;
            D_upper[14] += 5.0 * d3_X22;

            tmp_corrections[0] -= m_partner[19] * (D_upper[9] * multipole_interactions::factor_sixth[19]);
            tmp_corrections[1] -= m_partner[19] * (D_upper[13] * multipole_interactions::factor_sixth[19]);
            tmp_corrections[2] -= m_partner[19] * (D_upper[14] * multipole_interactions::factor_sixth[19]);
        }
        template <typename T, typename func>
        CUDA_GLOBAL_METHOD inline void compute_kernel_p2m_non_rho(T (&X)[NDIM], T (&Y)[NDIM],
            T (&m_partner)[20], T (&tmpstore)[4], func&& max) noexcept {
            T dX[NDIM];
            dX[0] = X[0] - Y[0];
            dX[1] = X[1] - Y[1];
            dX[2] = X[2] - Y[2];
        ...
        CUDA_GLOBAL_METHOD inline void compute_kernel_p2m_rho(T (&X)[NDIM], T (&Y)[NDIM],
            ...
            compute_interaction_p2m_rho(
                d2, d3, X_00, X_11, X_22, m_partner, dX, tmp_corrections);
        }
    }    // namespace monopole_interactions
}    // namespace fmm
}    // namespace octotiger
