...
const hydro::recon_type<NDIM>& hydro_computer<NDIM, INX, PHYS>::reconstruct_cuda(f_data_t &U_, const hydro::x_type &X, safe_real omega) {
...
template<int NDIM, int INX, class PHYS>
const hydro::recon_type<NDIM>& hydro_computer<NDIM, INX, PHYS>::reconstruct(const f_data_t &U_, const hydro::x_type &X, safe_real omega) {
	PROFILE();
