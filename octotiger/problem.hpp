...
OCTOTIGER_EXPORT std::vector<real> radiation_diffusion_test_problem(real, real, real, real);
OCTOTIGER_EXPORT std::vector<real> radiation_coupling_test_problem(real, real, real, real);
