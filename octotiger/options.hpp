...
COMMAND_LINE_ENUM(problem_type, DWD, SOD, BLAST, NONE, SOLID_SPHERE, DOUBLE_SOLID_SPHERE, HERNQUIST, STAR, MOVING_STAR, RADIATION_TEST, ROTATING_STAR, MESA_STAR, MARSHAK, AMR_TEST, ADVECTION);
