...
constexpr real rho_floor_old = real(1.0e-12);
...
constexpr real DEFAULT_OMEGA = real(0.0);
...
constexpr real HALF = real(1.0 / 2.0);
constexpr real SIXTH = real(1.0 / 6.0);
constexpr real TWELFTH = real(1.0 / 12.0);

constexpr real ei_floor = real(1.0e-15);

#define USE_RK3

#ifdef USE_RK3
constexpr integer NRK = 3;
constexpr real rk_beta[3] = { real(1.0), real(1.0 / 4.0), real(2.0 / 3.0) };
#else
